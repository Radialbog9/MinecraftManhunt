# Config
__Note:__ When updating the plugin to a newer version you may need to regenerate the config.
...
language:
  ...
  time-up: '&6[Manhunt]&r&a The runner has not been killed in time!'
```